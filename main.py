...
tot_radius_1=filtered_profile1_df['photosphere_r']
tot_mass=filtered_profile1_df['star_mass']
...
norm_radius=(filtered_profile1_df['radius']-filtered_profile1_df['radius'].min())/(tot_radius_1-filtered_profile1_df['radius'].min())
norm_mass=(filtered_profile1_df['mass']-filtered_profile1_df['mass'].min())/(tot_mass-filtered_profile1_df['mass'].min())
...
norm_t=(train_filtered_profile1_df['logT']-train_filtered_profile1_df['logT'].min())/(train_filtered_profile1_df['logT'].max()-train_filtered_profile1_df['logT'].min())
norm_energy=(train_filtered_profile1_df['energy']-train_filtered_profile1_df['energy'].min())/(train_filtered_profile1_df['energy'].max()-train_filtered_profile1_df['energy'].min())
...
plt.plot(norm_radius,filtered_profile1_df['logRho'])
plt.show()

plt.plot(norm_radius,filtered_profile1_df['logT'])
plt.show()
